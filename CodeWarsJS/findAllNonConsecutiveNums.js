...
////////////////////////////////////////////////////////////////////
// What I learned
// This one was pretty hard for me. Loops are much more flexible than I initially realized. I was having trouble with this, thinking for sure I'd need to use map, but I couldn't really figure
// that out like my favored solution did. I started back over and tried to just reason through how I could compare everything and came up with starting the loop at the [1]
// so that I could compare with the previous value + 1. That seems to work fine.