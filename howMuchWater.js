...
function howMuchWater(water, load, clothes) {
    if (clothes > 2 * load) {
      ...
      const waterNeeded = water * Math.pow(1.1, extraClothes);
      return parseFloat(waterNeeded.toFixed(2));
    }
  }
...
////////////////////////////////////////////////////////////////////
// What I learned
// Math is hard! I also learned more about how to use the parseFloat method.